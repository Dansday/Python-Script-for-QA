...
def crawl_sitemap(url, writer):
    ...
    url_map = {
        'https://iprice.hk/': 'https://ip-27342-iprice-hk.iprice.mx/',
        'https://iprice.co.id/': 'https://ip-27342-iprice-id.iprice.mx/',
        'https://iprice.my/': 'https://ip-27342-iprice-my.iprice.mx/',
        'https://iprice.ph/': 'https://ip-27342-iprice-ph.iprice.mx/',
        'https://iprice.sg/': 'https://ip-27342-iprice-sg.iprice.mx/',
        'https://ipricethailand.com/': 'https://ip-27342-iprice-th.iprice.mx/',
        'https://iprice.vn/': 'https://ip-27342-iprice-vn.iprice.mx/',
        'https://iprice.au/': 'https://ip-27342-iprice-au.iprice.mx/'
    }
    ...
    for url in urls:
        ...
        for old_url, new_url in url_map.items():
            sitemap_url = sitemap_url.replace(old_url, new_url)
